...
class PipelineGoldenTest {
    ...
    private fun lerPatch(o: JSONObject) = PipelinePatch(
        ...
        limiarEntradaN = o.optDoubleOrNull("limiarEntradaN"),
        limiarSaidaN = o.optDoubleOrNull("limiarSaidaN"),
        tempoEntradaMs = o.optIntOrNull("tempoEntradaMs")?.toLong(),
        tempoSaidaMs = o.optIntOrNull("tempoSaidaMs")?.toLong(),
        ...
        ativoZeroTracking = o.optBooleanOrNull("ativoZeroTracking"),
        zeroTrackingLimiarN = o.optDoubleOrNull("zeroTrackingLimiarN"),
        zeroTrackingTempoMs = o.optIntOrNull("zeroTrackingTempoMs")?.toLong(),
        zeroTrackingAlpha = o.optDoubleOrNull("zeroTrackingAlpha"),
